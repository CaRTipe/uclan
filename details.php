...
const tshirts = [
      ['UCLan Logo Tshirt-Navy Blue New','Cotton authentic character and practicality are combined in this summery t-shirt for students that goes with everything to create casual looks.','£19.99','tshirts/tshirt(1).jpg'],
      ['UCLan Logo Tshirt-Rusty Red New','Cotton authentic character and practicality are combined in this summery t-shirt for students that goes with everything to create casual looks.','£19.99','tshirts/tshirt(2).jpg'],
      ['UCLan Logo Tshirt-Burgundy','Cotton authentic character and practicality are combined in this summery t-shirt for students that goes with everything to create casual looks.','£19.99','tshirts/tshirt(3).jpg']
    ];

const products = document.getElementById('SSproducts.html');
    const item = document.getElementById('details.html');
    ...
    for (i = 0; i <tshirts.length; ++i){
      ...
      var value = "item" + i;
      itemCopy.id = value;
      itemCopy.querySelector('.itemInfo').querySelector('.itemName').innerHTML = tshirts[i][0];
      itemCopy.querySelector('.itemInfo').querySelector('.itemColor').innerHTML = tshirts[i][1];
      itemCopy.querySelector('.itemInfo').querySelector('.itemPrice').innerHTML = tshirts[i][3];
      itemCopy.querySelector('.itemImage').querySelector('.src').src = tshirts[i][4];
    ...
    <footer> <!-- Footer Section -->
        <div class="footer">
            ...
            <div class="contact"> <!-- Contact information -->
                ...
                <p>Phone: 01772893000</p>
            </div>
        <div class="location"> <!-- Location details -->
            <h2>Location</h2>
            <p>University of Central Lancashire Student's Union</p><br>
            <p>Flyde Road, Preston, PR1 7BY</p><br>
            <p>Registered in England</p><br>
            <p>Company Number: 7623917</p><br>
